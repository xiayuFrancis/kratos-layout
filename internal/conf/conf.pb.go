...
type Logger struct {
	...
	Format           string                 `protobuf:"bytes,2,opt,name=format,proto3" json:"format,omitempty"`                                               // 日志格式: json, console
	OutputPaths      string                 `protobuf:"bytes,3,opt,name=output_paths,json=outputPaths,proto3" json:"output_paths,omitempty"`                  // 日志输出路径，多个路径用逗号分隔
	ErrorOutputPaths string                 `protobuf:"bytes,4,opt,name=error_output_paths,json=errorOutputPaths,proto3" json:"error_output_paths,omitempty"` // 错误日志输出路径
	Development      bool                   `protobuf:"varint,5,opt,name=development,proto3" json:"development,omitempty"`                                    // 是否为开发模式
	Rotate           *Logger_RotateConfig   `protobuf:"bytes,6,opt,name=rotate,proto3" json:"rotate,omitempty"`                                               // 日志轮转配置
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *Logger) GetErrorOutputPaths() string {
	if x != nil {
...
func (x *Logger) GetRotate() *Logger_RotateConfig {
	if x != nil {
		return x.Rotate
	}
	return nil
...
type Data_Kafka struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Brokers       []string               `protobuf:"bytes,1,rep,name=brokers,proto3" json:"brokers,omitempty"`                       // Kafka 代理地址列表
	GroupId       string                 `protobuf:"bytes,2,opt,name=group_id,json=groupId,proto3" json:"group_id,omitempty"`        // 消费者组ID
	ClientId      string                 `protobuf:"bytes,3,opt,name=client_id,json=clientId,proto3" json:"client_id,omitempty"`     // 客户端ID
	EnableTls     bool                   `protobuf:"varint,4,opt,name=enable_tls,json=enableTls,proto3" json:"enable_tls,omitempty"` // 是否启用TLS
	Username      string                 `protobuf:"bytes,5,opt,name=username,proto3" json:"username,omitempty"`                     // SASL 用户名
	Password      string                 `protobuf:"bytes,6,opt,name=password,proto3" json:"password,omitempty"`                     // SASL 密码
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Data_Kafka) GetEnableTls() bool {
	if x != nil {
		return x.EnableTls
	}
	return false
...
type Logger_RotateConfig struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Filename      string                 `protobuf:"bytes,1,opt,name=filename,proto3" json:"filename,omitempty"`                        // 日志文件名
	MaxSize       int32                  `protobuf:"varint,2,opt,name=max_size,json=maxSize,proto3" json:"max_size,omitempty"`          // 单个日志文件最大大小，单位MB
	MaxAge        int32                  `protobuf:"varint,3,opt,name=max_age,json=maxAge,proto3" json:"max_age,omitempty"`             // 日志文件保留天数
	MaxBackups    int32                  `protobuf:"varint,4,opt,name=max_backups,json=maxBackups,proto3" json:"max_backups,omitempty"` // 保留的旧日志文件最大数量
	Compress      bool                   `protobuf:"varint,5,opt,name=compress,proto3" json:"compress,omitempty"`                       // 是否压缩旧日志文件
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *Logger_RotateConfig) Reset() {
	*x = Logger_RotateConfig{}
	mi := &file_internal_conf_conf_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *Logger_RotateConfig) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Logger_RotateConfig) ProtoMessage() {}

func (x *Logger_RotateConfig) ProtoReflect() protoreflect.Message {
	mi := &file_internal_conf_conf_proto_msgTypes[9]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Logger_RotateConfig.ProtoReflect.Descriptor instead.
func (*Logger_RotateConfig) Descriptor() ([]byte, []int) {
	return file_internal_conf_conf_proto_rawDescGZIP(), []int{3, 0}
}

func (x *Logger_RotateConfig) GetFilename() string {
	if x != nil {
		return x.Filename
	}
	return ""
...
func (x *Logger_RotateConfig) GetMaxSize() int32 {
	if x != nil {
		return x.MaxSize
	}
	return 0
...
func (x *Logger_RotateConfig) GetMaxAge() int32 {
	if x != nil {
		return x.MaxAge
	}
	return 0
...
func (x *Logger_RotateConfig) GetMaxBackups() int32 {
	if x != nil {
		return x.MaxBackups
	}
	return 0
...
func (x *Logger_RotateConfig) GetCompress() bool {
	if x != nil {
		return x.Compress
	}
	return false
...
const file_internal_conf_conf_proto_rawDesc = "" +
	...
	"\x06logger\x18\x03 \x01(\v2\x12.kratos.api.LoggerR\x06logger\"\xb8\x02\n" +
	"\x06Server\x12+\n" +
	...
	"\anetwork\x18\x01 \x01(\tR\anetwork\x12\x12\n" +
	"\x04addr\x18\x02 \x01(\tR\x04addr\x123\n" +
	"\atimeout\x18\x03 \x01(\v2\x19.google.protobuf.DurationR\atimeout\"\xbe\x04\n" +
	"\x04Data\x125\n" +
	...
	"\n" +
	"enable_tls\x18\x04 \x01(\bR\tenableTls\x12\x1a\n" +
	"\busername\x18\x05 \x01(\tR\busername\x12\x1a\n" +
	"\bpassword\x18\x06 \x01(\tR\bpassword\"\x80\x03\n" +
	"\x06Logger\x12\x14\n" +
	"\x05level\x18\x01 \x01(\tR\x05level\x12\x16\n" +
	"\x06format\x18\x02 \x01(\tR\x06format\x12!\n" +
	"\foutput_paths\x18\x03 \x01(\tR\voutputPaths\x12,\n" +
	"\x12error_output_paths\x18\x04 \x01(\tR\x10errorOutputPaths\x12 \n" +
	"\vdevelopment\x18\x05 \x01(\bR\vdevelopment\x127\n" +
	"\x06rotate\x18\x06 \x01(\v2\x1f.kratos.api.Logger.RotateConfigR\x06rotate\x1a\x9b\x01\n" +
	"\fRotateConfig\x12\x1a\n" +
	"\bfilename\x18\x01 \x01(\tR\bfilename\x12\x19\n" +
	"\bmax_size\x18\x02 \x01(\x05R\amaxSize\x12\x17\n" +
	"\amax_age\x18\x03 \x01(\x05R\x06maxAge\x12\x1f\n" +
	"\vmax_backups\x18\x04 \x01(\x05R\n" +
	"maxBackups\x12\x1a\n" +
	"\bcompress\x18\x05 \x01(\bR\bcompressB\x1fZ\x1dkratosdemo/internal/conf;confb\x06proto3"
...
var file_internal_conf_conf_proto_goTypes = []any{
	...
	(*Logger_RotateConfig)(nil), // 9: kratos.api.Logger.RotateConfig
...
var file_internal_conf_conf_proto_depIdxs = []int32{
	...
	9,  // 8: kratos.api.Logger.rotate:type_name -> kratos.api.Logger.RotateConfig
